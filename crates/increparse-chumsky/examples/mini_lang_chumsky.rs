...
//! `increparse-chumsky` showcase.
//!
//! The pass emits *slice-relative* [`SimpleSpan`]s; `increparse_chumsky::chumsky_pass`
...
//!
//! Run with `cargo run -p increparse-chumsky --example mini_lang_chumsky`.
