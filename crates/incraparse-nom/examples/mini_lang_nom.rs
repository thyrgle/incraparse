...
//! hand-rolled scanning — the `incraparse-nom` showcase.
//!
...
//! ranges; `incraparse_nom::nom_pass` rebases them to absolute spans so the
...
//!
//! Run with `cargo run -p incraparse-nom --example mini_lang_nom`.
